...
# regex to extract origin, destination, time, and date (can handle dd/mm/yyyy or day-name):
...
def generate_response(user_input):
    ...
    if intent_tag == "delay_prediction":
        ...
        if time_str:
            query += f" at {time_str}"
        if day_str:
            # normalise day or leave as-is if it's a date:
        ...
        # get Machine learning functions:
